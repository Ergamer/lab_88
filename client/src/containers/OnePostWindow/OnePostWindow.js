...
import {fetchOnePost} from "../../store/actions/posts";
import PostInside from '../../components/PostInside/PostInside';
import FormElement from "../../components/UI/Form/FormElements";
import {addComments, fetchComments} from "../../store/actions/posts";
...
export default connect(mapStateToProps, mapDispatchToProps)(OnePostWindow);
